...
This file provides **instructions for AI coding assistants** (copilot, GitHub Copilot, etc.) when working on the Personal Finance Tracker codebase. Follow these rules to ensure consistent, correct, and well-documented implementations.
...
| `ANTHROPIC_API_KEY` | Optional | Anthropic API key (if using copilot) |
...
This copilot.md is derived from:
