...
This file provides **instructions for AI coding assistants** (Claude, GitHub Copilot, etc.) when working on the Personal Finance Tracker codebase. Follow these rules to ensure consistent, correct, and well-documented implementations.
